	<!-- ADDENDIO SEARCH  -->
			...
			<div class="fleft col-md-2 no-padding hidden-sm hidden-xs">
				<a href="https://addendio.com/contact/?utm_source=pluginlite&utm_medium=themes&utm_campaign=searchpage_logo" target="_blank">
	...
	<div class="content-wrapper"> <!-- CONTENT-WRAPPER  -->
		...
		<div class="fleft col-md-2 hidden-sm hidden-xs">
			<aside>
